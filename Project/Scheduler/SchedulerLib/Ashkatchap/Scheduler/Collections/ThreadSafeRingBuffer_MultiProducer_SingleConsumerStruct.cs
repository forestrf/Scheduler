...
namespace Ashkatchap.Scheduler.Collections {
	internal class ThreadSafeRingBuffer_MultiProducer_SingleConsumerStruct<T> where T : struct {
		...
		public ThreadSafeRingBuffer_MultiProducer_SingleConsumerStruct(ushort powerOfTwoForCapacity, Thread consumer) {
